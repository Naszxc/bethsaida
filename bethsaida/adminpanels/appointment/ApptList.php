<!-- ---------------ITO NAMAN YUNG SA APPOINTMENT TABLE------------------ -->
										  <!-- ---------------------IPASOK MO NALANG SA DIV KUNG DOON KA SASAYA------------------ -->
											<table>
												...
												<tbody>
													<?php 
														$result = $conn->query("select s.bs_id, s.sc_id, s.date, s.time, s.appt_type, u.bs_fname, u.bs_lname, u.bs_mname from schedule s inner join users u on s.bs_id = u.bs_id;");
